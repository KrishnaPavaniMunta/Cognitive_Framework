...
video_path = Path(r"D:\Object Detection Model\yolo_tr\yolo_tr\Cognitive Recognition framework\10_Testing\Rules for AD\IMG_1047.MOV")
...
out_path = out_dir / f"{video_path.stem}_annotated_fix2.mp4"
